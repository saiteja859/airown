...
export default function AboutUs() {
  const metrics = [
    { label: 'Autonomous Flights', value: '10+', icon: Zap, color: 'text-luxury-gold' },
    { label: 'Avg. Delivery Speed', value: '8.4 Mins', icon: Clock, color: 'text-luxury-copper' },
    { label: 'Carbon Emissions', value: '0.00%', icon: Leaf, color: 'text-emerald-600' },
    { label: 'System Reliability', value: '99.99%', icon: ShieldCheck, color: 'text-luxury-graphite' },
  ];
    ...
    <section id="about-us" className="relative py-16 md:py-20 overflow-hidden bg-gray-50 border-b border-gray-200">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          className="w-full bg-white rounded-[32px] border-2 border-gray-300 shadow-sm p-8 md:p-12 transition-all duration-300 hover:border-luxury-gold"
        >
          {/* Mission Content */}
          <div className="flex flex-col items-center text-center mb-10 pb-8 border-b border-gray-200">
            <div className="mb-4 p-3.5 rounded-2xl bg-luxury-gold/5 border-2 border-luxury-gold/30 text-luxury-gold flex items-center justify-center">
            ...
            <p className="text-xs sm:text-sm font-light text-luxury-graphite leading-relaxed max-w-xl">
            ...
            {metrics.map((metric, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-widest text-luxury-titanium mt-0.5">
                    {metric.label}
                  </span>
                </div>
              );
